...
experience at Concentrix, handling Hyundai customer 
escalations every single day.
...
During my time at Concentrix supporting Hyundai 
customers, I noticed a pattern that repeated itself 
every single day:

- Customers called angry about warranty coverage
- They felt Hyundai should fix their car at no cost
...
After 12 months of data I formed this hypothesis:
...
Hyundai customers are blindsided by warranty 
expiration and coverage gaps at the worst possible 
moment — when their car breaks down — because 
Hyundai communicates warranty information too late, 
too generically, and too passively.
...
| Metric | Impact |
|---|---|
| Warranty complaint calls | Thousands daily across Hyundai India |
| Escalation rate | ~40% of warranty calls reach supervisor level |
| Agent time per escalation | 20–35 minutes vs 8–10 for normal calls |
...
calls through proactive communication saves Hyundai 
...
### Root Cause 1 — Outdated or inaccessible warranty information
...
### Root Cause 2 — Information delivered at the wrong moment
...
exists. Hyundai has all the data. The solution is 
...
**Platform:** MyHyundai mobile app + SMS + Email + 
Bluelink + Mail

**Business context:** Every escalated warranty call 
costs Hyundai 3x the time of a normal call. Reducing 
escalations by 20% saves significant operational 
costs while improving brand perception and customer 
loyalty.
...
**Primary user: The Confused Hyundai Customer**

Meet Priya. She bought a Hyundai Creta 3 years ago.
...
- When her transmission fails next month she will 
  call Hyundai furious — convinced it should be covered
...
**Need 1 — Know what's covered before something breaks**
...
last year but her powertrain warranty is still active 
for 2 more months. She needs clarity on each.

**Need 3 — Know what to do next**
When Priya learns her warranty is expiring she needs 
a clear, simple next action. Not information overload. 
Just one thing to do — book a service check.
...
**Option A — Hyundai Warranty Tracker (App Feature)**
A dedicated section in the MyHyundai app showing 
all active warranties for the customer's specific 
vehicle — with expiry dates, coverage details, and 
countdown timers for each warranty type.

**Option B — Proactive SMS + Deep Link**
Automated personalised SMS sent 90, 60, and 30 days 
before each warranty expiry. Message includes 
...
update — what's active, what's expiring, what to 
watch for.
...
"Hi Priya, your Hyundai Creta's powertrain warranty 
expires in 30 days on 25 June 2026. Your engine and 
transmission will no longer be covered after this date. 
Book a service check today: [link]"

Risk: SMS without follow-up is easy to ignore.
Mitigation: Phase 2 gives them a place to go.

**Phase 2 — Option A (Warranty Tracker App Feature)**
...
Risk: Dealers are independent bodies — Hyundai 
...
Hyundai customers like Priya are blindsided by 
warranty expiration because information reaches 
them too late and too generically.

The Hyundai Warranty Tracker solves this in 
three phases:
...
I spent 12 months at Concentrix handling Hyundai 
warranty escalations daily. Here is what I know 
that no PM sitting in a product team knows:
...
- The fact that dealerships are independent bodies 
  — Hyundai cannot legally mandate their behaviour, 
  only incentivise it
...
- Operational constraints (dealer independence) 
...
|---|---|
| Hyundai India | Direct application |
| Tata Motors | Same automotive warranty problem |
...
at Concentrix supporting Hyundai customers.*
